...
import { deleteThongBao, fetchThongBao, readThongBao, thongBaoActions } from '@redux/thongBaoSlice'
    ...
    return (
        <View style={styles.container}>
            {thongBaos?.map((item: ThongBao) =>
                <TouchableOpacity onPress={() => handlePress(item)} key={item.id} activeOpacity={0.8} style={[styles.item, !item.daXem && { backgroundColor: '#e4f2ff' }]}>
